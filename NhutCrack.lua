...
local function LoadAimbot()
    ...
    pcall(function()
        ...
        ScreenGui.Name = "AimbotMobileSystem"
        ScreenGui.ResetOnSpawn = false
        ScreenGui.DisplayOrder = 9999999
        ScreenGui.IgnoreGuiInset = true

        -- 1. Vòng tròn FOV tâm màn hình
